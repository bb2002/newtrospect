# Eval 3-articles [round2] — 2026-05-22T01:13:45.732Z
...
### 🟡 context
- model: gemini-3.1-flash-lite-preview, 1694ms
...
### 🔴 sensational
- model: gemini-3.1-flash-lite-preview, 1344ms
...
### 🔵 term
- model: gemini-3.1-flash-lite-preview, 2232ms
- matched=7/10 (recall 70%) · api=8 (precision 88%)
- matched:
  - REF `OLAP` ↔ API `OLAP`
  - REF `TTL` ↔ API `TTL`
  - REF `뮤텍스` ↔ API `뮤텍스`
...
### 🟢 quantitative
- model: gemini-3.1-flash-lite-preview, 2029ms
...
### 🟡 context
- model: gemini-3.1-flash-lite-preview, 2057ms
- matched=2/3 (recall 67%) · api=2 (precision 100%)
- matched:
...
### 🔴 sensational
- model: gemini-3.1-flash-lite-preview, 1492ms
...
### 🔵 term
- model: gemini-3.1-flash-lite-preview, 2405ms
...
### 🟢 quantitative
- model: gemini-3.1-flash-lite-preview, 1501ms
...
### 🟡 context
- model: gemini-3.1-flash-lite-preview, 1277ms
- matched=3/3 (recall 100%) · api=3 (precision 100%)
- matched:
...
### 🔴 sensational
- model: gemini-3.1-flash-lite-preview, 903ms
- matched=1/1 (recall 100%) · api=1 (precision 100%)
- matched:
  - REF `삼성전자 노사가 사업성과의 10%대를 성과급 재원으로 고정하는 파격적 보상안에 합의했다.` ↔ API `삼성전자 노사가 사업성과의 10%대를 성과급 재원으로 고정하는 파격적 보상안에 합의했다.`

### 🔵 term
- model: gemini-3.1-flash-lite-preview, 1749ms
...
### 🟢 quantitative
- model: gemini-3.1-flash-lite-preview, 3254ms
...
|---|---|---|---|---|---|---|
| 🟡 context | 10 | 8 | 7 | 88% | 70% | 0.78 |
| 🔴 sensational | 5 | 6 | 5 | 83% | 100% | 0.91 |
| 🔵 term | 25 | 24 | 20 | 83% | 80% | 0.82 |
...
|---|---|---|---|---|
| b1-clickhouse | 2/4 (api 3) | 1/1 (api 2) | 7/10 (api 8) | 10/10 (api 10) |
| b2-tumen | 2/3 (api 2) | 3/3 (api 3) | 5/6 (api 8) | 6/6 (api 6) |
| b3-samsung-tax | 3/3 (api 3) | 1/1 (api 1) | 8/9 (api 8) | 13/13 (api 14) |